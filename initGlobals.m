...
% flexible scoping. Instead, we pass globals between function calls in the data pipeline.
...
% setup for investment optimization
...
% backed out from the desired overall variance.
globals.rhoWage = 0.7;
